...
Phases 1-23 已完成，共 84 项验收 (F001-F084) 全部通过，341 个测试，lint clean。Phase 22 增加回复风格、播报摘要长度配置、东方浩然/阿虎 Seed TTS 2.0 音色，以及 Stop Current Run 取消当前 Claude CLI 任务和当前 TTS 播报。Phase 23 增加 402 余额不足中文提示、Current Status 菜单状态显示、Reload Config 热重载配置，以及 MANUAL_TEST_CURRENT.md 人工验收文档。
...
Current main — F001-F084 (Phase 1-23) 全部通过。341 个测试。详情见 `feature_list.json`、`RELEASE_NOTES.md`。
