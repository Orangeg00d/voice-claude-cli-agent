...
| Testing | pytest (289 tests) | Full pipeline + UI + concurrency + cloud STT/TTS + workdir coverage |

## Project Status

- **Version**: v0.1.0
- **Features**: 72 acceptance items (F001-F072), all passing on current `main`
- **Tests**: 289 (pytest), passing with `./init.sh test`
- **Lint**: ruff clean
