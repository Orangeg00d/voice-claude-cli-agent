...
| Testing | pytest (310 tests) | Full pipeline + UI + concurrency + cloud STT/TTS + workdir coverage |

## Project Status

- **Version**: v0.1.0
- **Features**: 78 acceptance items (F001-F078), all passing on current `main`
- **Tests**: 310 (pytest), passing with `./init.sh test`
- **Lint**: ruff clean
