...
| Testing | pytest (339 tests) | Full pipeline + UI + concurrency + cloud STT/TTS + workdir coverage |

## Project Status

- **Version**: v0.1.0
- **Features**: 84 acceptance items (F001-F084), all passing on current `main`
- **Tests**: 339 (pytest), passing with `./init.sh test`
- **Lint**: ruff clean
