...
| Testing | pytest (344 tests) | Full pipeline + UI + concurrency + cloud STT/TTS + workdir coverage |

## Project Status

- **Version**: v0.1.0
- **Features**: 87 acceptance items (F001-F087), all passing on current `main`
- **Tests**: 344 (pytest), passing with `./init.sh test`
- **Lint**: ruff clean
