...
| Testing | pytest (303 tests) | Full pipeline + UI + concurrency + cloud STT/TTS + workdir coverage |

## Project Status

- **Version**: v0.1.0
- **Features**: 75 acceptance items (F001-F075), all passing on current `main`
- **Tests**: 303 (pytest), passing with `./init.sh test`
- **Lint**: ruff clean
