...
| Testing | pytest (298 tests) | Full pipeline + UI + concurrency + cloud STT/TTS + workdir coverage |

## Project Status

- **Version**: v0.1.0
- **Features**: 74 acceptance items (F001-F074), all passing on current `main`
- **Tests**: 298 (pytest), passing with `./init.sh test`
- **Lint**: ruff clean
