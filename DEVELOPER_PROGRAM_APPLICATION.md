...
| Testing | pytest (297 tests) | Full pipeline + UI + concurrency + cloud STT/TTS + workdir coverage |

## Project Status

- **Version**: v0.1.0
- **Features**: 73 acceptance items (F001-F073), all passing on current `main`
- **Tests**: 297 (pytest), passing with `./init.sh test`
- **Lint**: ruff clean
