...
| Testing | pytest (255 tests) | Full pipeline + UI + concurrency + cloud STT mock coverage |

## Project Status

- **Version**: v0.1.0
- **Features**: 69 acceptance items (F001-F069), all passing on current `main`
- **Tests**: 255 (pytest), passing with `./init.sh test`
- **Lint**: ruff clean
